...
extension UIColor {
    struct FlatColor {
        ...
        struct ColorHunt {
            static let DarkPurple = UIColor(netHex: 0x3B3B98)
            static let Cream = UIColor(netHex: 0xf9ecec)
            static let DarkBlue = UIColor(netHex: 0x182C61)
            static let DiscoBlue = UIColor(netHex: 0x25CCF7)
            static let ClearBlue = UIColor(netHex: 0x1B9CFC)
        }
        ...
        struct Red {
            ...
            static let SasquatchSocks = UIColor(netHex: 0xFC427B)
            static let GeorgiaPeach = UIColor(netHex: 0xFD7272)
        }
